...
export default {
  ...
  methods: {
    rink() {
      ...
      getRank("54d42d92321052167dfb75e3").then(
        res => {
          if (res.data.ok) {
      ...
      getRank("54d43437d47d13ff21cad58b").then(
        res => {
          if (res.data.ok) {
    ...
    gengduonan() {
      getRank("54d42d92321052167dfb75e3").then(
        res => {
          if (res.data.ok) {
            this.maleList.push(
              ...res.data.ranking.books.slice(this.jia, this.jianan + 10)
            );
    ...
    gengduonv() {
      getRank("54d43437d47d13ff21cad58b").then(
        res => {
          if (res.data.ok) {
            this.femaleList.push(
              ...res.data.ranking.books.slice(this.jianv, this.jianv + 10)
            );
